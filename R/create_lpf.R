...
create_lpf <- function(dis = create_dis(),
                       ilpfcb = 0,
                       hdry = -888,
                       nplpf = 0,
                       ...
                       sy = create_rmodflow_array(0.15, dim = c(dis$nrow, dis$ncol, dis$nlay)),
                       vkcb = create_rmodflow_array(0, dim = c(dis$nrow, dis$ncol, dis$nlay)),
                       wetdry = create_rmodflow_array(-0.01, dim = c(dis$nrow, dis$ncol, dis$nlay))) {
  ...
  # data set 10-16
    lpf$hk <- create_rmodflow_array(hk)
    lpf$hani <- create_rmodflow_array(hani)
    lpf$vka <- create_rmodflow_array(vka)
    lpf$ss <- create_rmodflow_array(ss)
    lpf$sy <- create_rmodflow_array(sy)
    lpf$vkcb <- create_rmodflow_array(vkcb)
    lpf$wetdry <- create_rmodflow_array(wetdry)
