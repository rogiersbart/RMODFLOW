...
plot.rmodflow_4d_array <- function(array,
                          ...
                          ...) {
  if(!is.null(l)) {
    plot(create_rmodflow_array(array(array[,,,l],dim=dim(array)[1:3])), i=i, j=j, k=k, ...)
    ...
    plot(create_rmodflow_array(array(array[,,,dim(array)[4]],dim=dim(array)[1:3])), i=i, j=j, k=k, ...)
  }
}
